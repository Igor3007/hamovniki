...
/***/ "./src/blocks/modules/catalog/catalog-map/catalog-map.js":
/*!***************************************************************!*\
  !*** ./src/blocks/modules/catalog/catalog-map/catalog-map.js ***!
  \***************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function($) {var mapsParams = {
...
ymaps.ready(function () {
  ...
  try {
    ...
    var MyIconContentLayout = ymaps.templateLayoutFactory.createClass('<div class="pin-content" >$[properties.iconContent]</div>');
    var PlacemarkArr = [];
    ...
    var _loop = function _loop(i) {
      ...
      catalogMap.behaviors.disable('scrollZoom'); //autoscale

      if (mapsParams.autoscale) {
        catalogMap.setBounds(catalogMap.geoObjects.getBounds(), {
          checkZoomRange: true,
          zoomMargin: 50
        });
      }
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  ...
  function historyMain() {
    ...
    this.changeBg = function (index) {
      var link = $(this.item).eq(index - 1).find('.quiz-slide').attr('data-slide-bg');
      $(this.block).attr({
...
/* harmony import */ var _modules_catalog_catalog_map_catalog_map_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! %modules%/catalog/catalog-map/catalog-map.js */ "./src/blocks/modules/catalog/catalog-map/catalog-map.js");
/* harmony import */ var _modules_catalog_catalog_map_catalog_map_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_catalog_catalog_map_catalog_map_js__WEBPACK_IMPORTED_MODULE_5__);
...
jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).ready(function () {
  ...
  var region = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-swiper="region"]', {
    ...
    breakpoints: {
      0: (_ = {
        spaceBetween: 10,
        slidesPerView: 1
      }, _defineProperty(_, "slidesPerView", 1.2), _defineProperty(_, "centeredSlides", false), _),
      480: {
        spaceBetween: 10,
        centeredSlides: 'auto'
      },
  ...
  function updateFraction(slider) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-swiper-current="catalog-map"]').text(activeIndex + 1);
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-swiper-total="catalog-map"]').text(slider.slides.length);
  }

  var catalogmap = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-swiper="catalog-map"]', {
    slidesPerView: 1,
    spaceBetween: 5,
    //observer: true,
    //centeredSlides: 'auto',
  ...
  var gallery = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-swiper="gallery"]', {
    slidesPerView: 1.6,
    spaceBetween: 40,
    //observer: true,
    loop: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('click', '[data-gallery="current-thumb"] li a', function (event) {
    event.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).parents('ul').find('li').removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).parent().addClass('active');
    var link = jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).attr('href');
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).parents('.item-offer').find('[data-gallery="current-full"] .bgimage').css({
      'background-image': 'url(' + link + ')'
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('click', '[data-gallery="current-full"] a', function (event) {
    event.preventDefault();
    var images = jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).parents('.item-offer').find('[data-gallery="current-thumb"] li');
    var imagesArr = [];
    images.each(function () {
      imagesArr.push({
        src: jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).find('a').attr('href'),
        type: 'image'
      });
    });
    jquery__WEBPACK_IMPORTED_MODULE_5___default.a.fancybox.open(imagesArr, {
      loop: false,
      animationEffect: "zoom"
    });
  ...
  var defaultText = jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-filter="toggleMoreParams"]').text();
  var activeText = jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-filter="toggleMoreParams"]').data('active');
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('click', '[data-filter="toggleMoreParams"]', function (event) {
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('.catalog-filter__more').slideToggle(300);
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).toggleClass('open');

    if (jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).hasClass('open')) {
      jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-filter="toggleMoreParams"]').text(activeText);
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-filter="toggleMoreParams"]').text(defaultText);
    }
  });
  /* =============== */

  var minicard = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-swiper="minicard"]', {
    slidesPerView: 1,
    spaceBetween: 5,
    observer: true,
    loop: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('mouseenter', '.minicard__desc', function (event) {
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).parents('.minicard').addClass('hover');
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('mouseleave', '.minicard', function (event) {
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).removeClass('hover');
  });
  jquery__WEBPACK_IMPORTED_MODULE_5___default()(document).on('click', '[data-toggle]', function (event) {
    var elem = jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).attr('data-toggle');
    jquery__WEBPACK_IMPORTED_MODULE_5___default()('[data-toggle-elem="' + elem + '"]').toggleClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).toggleClass('active');
  }); // плавный скролл

  var $page = jquery__WEBPACK_IMPORTED_MODULE_5___default()('html, body');
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('.main-menu li a[href*="#"]').on('click', function () {
    var height = jquery__WEBPACK_IMPORTED_MODULE_5___default()('.header-top').height();
    $page.animate({
      scrollTop: jquery__WEBPACK_IMPORTED_MODULE_5___default()(jquery__WEBPACK_IMPORTED_MODULE_5___default.a.attr(this, 'href')).offset().top - height
    }, 400);
